            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100 relative">
                    ...
                    <div class="bg-gray-200 overflow-hidden h-60 relative">
                        <img src="{{ $profile->background_picture }}" alt="Background Picture"
                        ...
                        <div class="bg-white shadow-md rounded-lg p-6">
                            <div class="flex items-center">
                                <img src="{{ $profile->profile_picture }}" alt="Profile Picture"
                                    class="h-24 w-24 rounded-full mr-6">
                                <div class="px-6">
                            ...
                            <div class="mt-6">
                                <a href="{{ route('profile.edit') }}"
                                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-block text-center no-underline dark:bg-blue-800 dark:hover:bg-blue-900">
                                    Edit Profile
                                </a>
                            </div>
                        </div>
